...
Connects the current PowerShell session to one or more **Clustron Dictus
management servers**.

## Description

`Connect-DictusManager` establishes a management context used by all other
...
``` powershell
Connect-DictusManager -Servers <string[]> [-Port <int>] [-Force]
```
...
``` powershell
Connect-DictusManager -Servers 10.0.0.11
```
...
``` powershell
Connect-DictusManager -Servers 10.0.0.11,10.0.0.12,10.0.0.13
```
...
``` powershell
Connect-DictusManager -Servers 10.0.0.11:7800,10.0.0.12:7800
```
...
``` powershell
Connect-DictusManager -Servers http://10.0.0.11:7800,http://10.0.0.12:7800
```
...
``` powershell
Connect-DictusManager -Servers 10.0.0.11,10.0.0.12 -Port 7800
```
...
``` powershell
Connect-DictusManager -Servers 10.0.0.11,10.0.0.12 -Force
```
...
``` powershell
Connect-DictusManager -Servers node1,node2,node3
```
...
New-DictusStore -Name OrdersStore
```
