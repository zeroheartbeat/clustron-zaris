...
``` powershell
Stress-ZrStore -StoreName <string> -DurationSec <int> -Concurrency <int> [-ObjectSizeBytes <int>]
```
...
`Stress-ZrStore` executes a sustained workload against a Clustron store
...
``` powershell
Stress-ZrStore -StoreName TestStore -DurationSec 600 -Concurrency 32
```
...
``` powershell
Stress-ZrStore -StoreName TestStore -DurationSec 3600 -Concurrency 64
```
...
``` powershell
Stress-ZrStore -StoreName TestStore -DurationSec 600 -Concurrency 128
```
...
``` powershell
Stress-ZrStore -StoreName TestStore -DurationSec 600 -Concurrency 64 -ObjectSizeBytes 512
```
...
``` powershell
Stress-ZrStore -StoreName TestStore -DurationSec 1800 -Concurrency 256
```
...
``` powershell
Stress-ZrStore -StoreName TestStore -DurationSec 900 -Concurrency 64 -ObjectSizeBytes 1024
```
