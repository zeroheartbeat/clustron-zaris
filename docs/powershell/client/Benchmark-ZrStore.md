...
``` powershell
Benchmark-ZrStore -StoreName <string> -Profile <string> [-DurationSec <int>] [-Concurrency <int>] [-ObjectSizeBytes <int>]
```
...
`Benchmark-ZrStore` executes a configurable workload against a Clustron
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile Mixed
```
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile ReadHeavy
```
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile Mixed -DurationSec 120
```
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile Mixed -Concurrency 64
```
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile Mixed -ObjectSizeBytes 512
```
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile ReadHeavy -Concurrency 32
```
...
``` powershell
Benchmark-ZrStore -StoreName TestStore -Profile WriteHeavy -ObjectSizeBytes 1024
```
