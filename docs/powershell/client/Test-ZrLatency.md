...
``` powershell
Test-ZrLatency -StoreName <string> -Iterations <int> [-ObjectSizeBytes <int>]
```
...
`Test-ZrLatency` performs a latency benchmark against a Clustron store
by:
...
``` powershell
Test-ZrLatency -StoreName TestStore -Iterations 1000
```
...
``` powershell
Test-ZrLatency -StoreName TestStore -Iterations 5000
```
...
``` powershell
Test-ZrLatency -StoreName TestStore -Iterations 10000 -ObjectSizeBytes 512
```
...
``` powershell
Test-ZrLatency -StoreName TestStore -Iterations 5000 -ObjectSizeBytes 1024
```
